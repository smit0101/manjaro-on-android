...
"aarch64-linux-thread-multi-4.9.210-1-arch" or
	die "Errno architecture (aarch64-linux-thread-multi-4.9.210-1-arch) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
